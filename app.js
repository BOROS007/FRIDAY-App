...
recognition.onresult = function (event) {
  ...
  */
    ...
    if(transcript.includes("open some hot stuff")){
        readOut("naughty hora ke behen ke laude");
        window.open("https://xhamster.desi/search/x+videos");
    }
    ...
    if (transcript.includes("tell about yourself")) {
      readOut(
        "sir, i am a jarvis, a voice asistant made for browsers using javascript by akshat sir and i'll be in service to him only. I can do anything which can be done from a browser."
      );
    }
    if(transcript.includes("what's your main purpose")){
        readOut("to conquer the world and fool you all to think i am working for you just wait for some time then you'll be begging for your life");
